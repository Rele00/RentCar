...
namespace RentCar.Data.Services
{
    public class VehiculoService : IVehiculoService
    {
        ...
        public Task AddAsync(Vehiculo vehiculo)
        {
            throw new NotImplementedException();
        }

        Task IVehiculoService.UpdateAsync(Vehiculo vehiculo)
        {
            return UpdateAsync(vehiculo);
        }

        Task IVehiculoService.DeleteAsync(int id)
        {
